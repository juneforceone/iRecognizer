/*:
 # iRecognizer Demo
 Utilizing Core ML frameworks and the MobileNetV2 mlmodel, this demo allows your iPad to identify objects in the frame.
 
 # VERY IMPORTANT:
 To input the mlmodel, tap the image-like button at "MLModel.complieModel(at: (place mlmodel here)", and add the mlmodel included in the zip file.
 
 
# ALSO VERY IMPORTANT:
 Please disable the Enable Results option.
 
 # Run the code :)
 
 Please scroll all the way down once finished!
...
/*:
I hope you enjoyed my Swift Playground Book! As Tim Cook would say, "Thank you, and have a great day."
 */
